...
ksemillas  <- c(958381, 391873, 735389, 486037, 260747) #reemplazar por las propias semillas
...
ArbolEstimarGanancia  <- function( semilla, param_basicos )
{
  ...
  particionar( dataset, division=c(70,30), agrupa="clase_ternaria", seed= 958381 )  #Cambiar por la primer semilla de cada uno !
...
{
  for( vmin_split  in  c( 900, 850, 700, 650, 550, 400, 250, 100, 50 )  )
  {
    for(  vmin_bucket  in  c( 450, 350, 250, 200, 150, 100, 70, 50, 30 )  )
    {
