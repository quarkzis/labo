...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[  , ctrx_quarter_square  := ctrx_quarter^2 ]
  dataset[  , cpayroll_trx_square  := cpayroll_trx^2 ]  
  dataset[  , mcaja_ahorro_square  := mcaja_ahorro^2 ]
  dataset[  , mtarjeta_visa_consumo_square  := mtarjeta_visa_consumo^2 ]  
  dataset[  , ctarjeta_visa_trx_square  := ctarjeta_visa_trx^2 ]
  dataset[  , mcuentas_saldo_square  := mcuentas_saldo^2 ] 
  dataset[  , mrentabilidad_annual_square  := mrentabilidad_annual^2 ]
  dataset[  , mprestamos_personales_square  := mprestamos_personales^2 ] 
  dataset[  , mactivos_margen_square  := mactivos_margen^2 ]
  dataset[  , mpayroll_square  := mpayroll^2 ] 
  dataset[  , Visa_mpagominimo_square  := Visa_mpagominimo^2 ]
  dataset[  , cliente_edad_square  := cliente_edad^2 ] 
  dataset[  , chomebanking_trx_square  := chomebanking_trx^2 ]
  dataset[  , Visa_msaldopesos_square  := Visa_msaldopesos^2 ] 
  dataset[  , Visa_Fvencimiento_square  := Visa_Fvencimiento^2 ]
  dataset[  , mrentabilidad_square  := mrentabilidad^2 ] 
  dataset[  , Visa_msaldototal_square  := Visa_msaldototal^2 ]
  dataset[  , Master_Fvencimiento_square  := Master_Fvencimiento^2 ] 
  dataset[  , mcuenta_corriente_square  := mcuenta_corriente^2 ]
  dataset[  , Visa_mpagospesos_square  := Visa_mpagospesos^2 ] 
  dataset[  , limite_visa_square  := Visa_mlimitecompra^2 ]
  dataset[  , limite_master_square  := Master_mlimitecompra^2 ]  
  dataset[  , Visa_fechaalta_square  := Visa_fechaalta^2 ]
  dataset[  , mcomisiones_mantenimiento_square  := mcomisiones_mantenimiento^2 ]
  dataset[  , Visa_mfinanciacion_limite_square  := Visa_mfinanciacion_limite^2 ]
  dataset[  , mtransferencias_recibidas_square  := mtransferencias_recibidas^2 ]
  dataset[  , cliente_antiguedad_square  := cliente_antiguedad^2 ]
  dataset[  , Visa_mconsumospesos_square  := Visa_mconsumospesos^2 ]
  dataset[  , Master_mfinanciacion_limite_square  := Master_mfinanciacion_limite^2 ]
  dataset[  , mcaja_ahorro_dolares_square  := mcaja_ahorro_dolares^2 ]
  dataset[  , cproductos_square  := cproductos^2 ]
  dataset[  , mcomisiones_otras_square  := mcomisiones_otras^2 ]
  dataset[  , thomebanking_square  := thomebanking^2 ]
  dataset[  , mcuenta_debitos_automaticos_square  := mcuenta_debitos_automaticos^2 ]
  dataset[  , mcomisiones_square  := mcomisiones^2 ]
  dataset[  , Visa_cconsumos_square  := Visa_cconsumos^2 ]
  dataset[  , ccomisiones_otras_square  := ccomisiones_otras^2 ]
  dataset[  , Master_status_square  := Master_status^2 ]
  dataset[  , mtransferencias_emitidas_square  := mtransferencias_emitidas^2 ]
  dataset[  , mpagomiscuentas_square  := mpagomiscuentas^2 ]
